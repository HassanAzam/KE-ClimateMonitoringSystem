...
?>
<?php
	$status = file_get_contents("http://kfrlab.com/nodeapi/getstatus.php?api=VV1TVNRCTYRTD417");
		$t = file_get_contents("http://kfrlab.com/nodeapi/getthreshold.php?api=VV1TVNRCTYRTD417");
	$threshold = array();
	$threshold = explode(",",$t);
	$pos = strpos($status,"->");
	$APIkey = "VV1TVNRCTYRTD417";
	$deviceName = "NED Node";
	$cid = "71661";
			...
			<div id="cp" class="l">
				...
				<div class="accordion" style="background-color:#a3d637;">Threshold Settings</div>
					<div class="panel">
						...
						<table> <thead> <tr> <th>LDR Threshold</th> <th id="device1-status"><?php echo $threshold[0]; ?></th> </tr> <tr> <th>Temperature Threshold</th> <th id="device1-status"><?php echo $threshold[1]; ?></th> </tr> <tr> <th>Humidity Threshold</th> <th id="device1-status"><?php echo $threshold[2]; ?></th> </tr> </thead> <tbody> </tbody> </table>
...
<input type="hidden" name="page" value="node2.php">
<br>
...
<input type="submit" name="submit"/>
		...
		/* Toggle between adding and removing the "active" and "show" classes when the user clicks on one of the "Section" buttons. The "active" class is used to add a background color to the current button when its belonging panel is open. The "show" class is used to open the specific accordion panel */
			...
			*/
			...
			httpGetStatus("http://www.kfrlab.com/nodeapi/getstatus.php?api=KY25YJRLZISG8HMV");*/
